      ...
      <header className="fixed-top shadow-lg">
        <nav id="navbar" className="navbar navbar-expand-sm navbar-light bg-white fixed-top shadow-lg">
          <div className="container-fluid">
            ...
            <a className={'navbar-brand nav-item nav-link'} href={"/" + urlBaseFrontend + "/index"}><Logo color={myColor} /> <span className='main-color fs-sm-2 ps-5 ps-sm-0'>{ myTitle }</span></a>
