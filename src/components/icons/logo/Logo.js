export const Logo = ({ color='currentColor', className='', strokeWidth='0', width='1', height='1'}) => {
    return (
            <svg className={className} stroke={color} fill="#fff" strokeWidth={strokeWidth} viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round" height={height + 'em'} width={width + 'em'} xmlns="http://www.w3.org/2000/svg">
