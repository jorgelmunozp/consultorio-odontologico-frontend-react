...
const elementHtml = (urlApiConsultorios,pacientes,tratamientos,doctores,consultorios) =>  
  <center>
    <hr/>
...
const handleSortBy = async (dir,parameter,urlApiConsultorios,pacientes,tratamientos,doctores,consultorios) => {
  if(dir==="up"){
    if(parameter==="id") {
  ...
  renderContent(urlApiConsultorios,pacientes,tratamientos,doctores,consultorios);
}

const renderContent = (urlApiConsultorios,pacientes,tratamientos,doctores,consultorios) => {
  const root = ReactDOM.createRoot(document.getElementById('contenidoConsultorios'));
  root.render(elementHtml(urlApiConsultorios,pacientes,tratamientos,doctores,consultorios));
}

export const ConsultarConsultorios = ({ urlApiConsultorios,pacientes,tratamientos,doctores,consultorios }) => {
  return (
    <div className="App">
      <div id="contenidoConsultorios">
        { elementHtml(urlApiConsultorios,pacientes,tratamientos,doctores,consultorios) }
      </div>
    </div>
  );
};