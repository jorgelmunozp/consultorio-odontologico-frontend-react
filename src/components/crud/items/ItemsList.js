...
export const ItemsList = ({classType, Icons, titles=[], urlApi, array, SortByProperty, setSortBy, indexPage, handleItems }) => {
  return (
    <div className={'container-fluid border overflow-auto px-0' }>
        ...
        { array.sort(SortByProperty).slice(indexPage[0],indexPage[1]).map((item,index) => { return (
