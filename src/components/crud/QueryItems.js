    ...
    <div className="App">
      <div className='mt-4 mt-sm-5'>
        <center>
          ...
          <SearchBar icon={<IconSearch height={iconHeight} width={iconWidth} strokeWidth={iconStrokeWidth} className={'main-color'}/>} placeholders={titles} queries={queries} setQueries={setQueries} isMenuOpen={isMenuOpen} className={'float-end me-0 smooth' + (isMenuOpen ? ' w-responsive':' w-100')} />
        </center>
