...
export const CreateConsultorio = ({ urlApi }) => {
  ...
  return (
    <div className="App">
      ...
      { alert === 'success' && <Modal Icon={Success} iconColor={'#0f0'} setOpen={setAlert} title={'Consultorio Registrado'} />  }
      { alert === 'error' && <Modal Icon={Error} iconColor={'#f00'} setOpen={setAlert} title={'Consultorio No Registrado'} />  }
    </div>
  );
};