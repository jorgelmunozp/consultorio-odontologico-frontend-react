...
export const ViewPacientes = ({ isMenuOpen, setMenu }) => {
  const services = [
    { 'title':'Consultar', 'menu':6, 'icon':<UserSearch height={4} width={4} strokeWidth={1} className='text-muted main-color' /> },
    { 'title':'Registrar', 'menu':7, 'icon':<UserPlus height={4} width={4} strokeWidth={1} className='text-muted main-color' /> },
  ];
