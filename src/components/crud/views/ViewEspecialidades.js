...
export const ViewEspecialidades = ({ isMenuOpen, setMenu }) => {
  const services = [
    { 'title':'Consultar', 'menu':15, 'icon':<HearthSearch height={4} width={4} strokeWidth={1} className='text-muted main-color' /> },
    { 'title':'Registrar', 'menu':16, 'icon':<HearthPlus height={4} width={4} strokeWidth={1} className='text-muted main-color' /> },
  ];
