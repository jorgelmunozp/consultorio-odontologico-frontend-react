      ...
      <center>
        <table class="modalTable" border='1'>
          ...
          <tr>
            ...
            <td> Fecha </td>
            <td><input id="editarFecha" type="date" value=${ item.cita.fecha } class="modalInput dateSelector"></input></td>
          <tr>
          </tr>     
            <td> Hora </td>
            <td><input id="editarHora" type="time" value=${ item.cita.hora } class="modalInput timeSelector"></input></td>
          <tr>
          </tr>
            <td> Consultorio </td>
            <td>
