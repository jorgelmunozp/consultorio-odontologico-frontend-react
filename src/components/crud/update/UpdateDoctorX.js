        ...
        <table class="modalTable" border='1'>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><input id="editarIdentificacion" type="number" value=${ item.doctor.identificacion } class="modalInput"></input></td>
            <tr>
            </tr>        
              <td> Nombre </td>
              <td><input id="editarNombre" type="text" value=${ item.doctor.nombre } class="modalInput"></input></td>
            <tr>
            </tr>     
              <td> Apellido </td>
              <td><input id="editarApellido" type="text" value=${ item.doctor.apellido } class="modalInput"></input></td>
            <tr>
            </tr>        
              <td> Género </td>
              <td>
