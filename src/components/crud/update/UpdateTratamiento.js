...
export const UpdateTratamiento = ({ Icon, item, urlApi, title, buttons, setOpen, setAlert, Row, numero, nombre, handleChangeNumero, handleChangeNombre }) => {
  const handleUpdate = () => {
    if(nombre !== "") {
      item.tratamiento.nombre = nombre
