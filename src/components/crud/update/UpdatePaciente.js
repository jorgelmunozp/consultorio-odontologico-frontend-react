...
export const UpdatePaciente = ({ Icon, item, urlApi, title, buttons, setOpen, setAlert, Row, numero, nombre, handleChangeNumero, handleChangeNombre }) => {
  const handleUpdate = () => {
    if(numero !== "" && nombre !== "" ) {
      item.paciente.numero = numero;
      item.paciente.nombre = nombre
