        ...
        <table className="table" border='1'>
          <thead>
            <tr>
              ...
              <th className='border-0 py-0 px-1 px-2 px-sm-3'colSpan='3'></th>
            </tr>
          </thead>
          <tbody>
            {
              tratamientos.sort(sortBy === 1 ? sortByIdUp 
                ...
                <tr key={ tratamiento.id }>
                  ...
                  <td className='px-2 px-sm-3 text-nowrap'>{ tratamiento.tratamiento.nombre }</td>
                  <td className='ps-4 ps-sm-5 text-nowrap'>{ tratamiento.tratamiento.consultorio }</td>
                  <td className='px-2 px-sm-3 text-nowrap'>{ tratamiento.tratamiento.doctor }</td>
